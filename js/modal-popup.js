...
(function ($, window) {
      ...
      switch (columns) {
        ...
        case 2:
          ...
          $('.choose-child-items').click(function () {
            result.value = firstChooseEle.attr('data-num') + '@' + $(this).attr('value');
        ...
        case 3:
          ...
          $('.choose-lists').on('click', '.choose-child-items', function () {
            ...
            secondChooseEle.removeClass('active').text($(this).text()).attr('data-num', $(this).attr('value'));
            ...
            $('.choose-last-items').click(function () {
              ...
              result.value = firstChooseEle.attr('data-num') + '@' + secondChooseEle.attr('data-num') + '@' + $(this).attr('value');
  ...
  ModalPopup.prototype.secondChooseHtml = function (num, _this) {
    ...
    firstChooseEle.text(!_this ? firstChooseEle.text() : _this.text()).removeClass('active').attr('data-num', !_this ? firstChooseEle.text() : _this.attr('value')); //赋值
